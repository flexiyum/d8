...
biar user senang bs multilogin lagi.." | boxes -d capgirl | lolcat
	break
	;;
...
User Sudah Bisa Multi Login Lagi!!!" | boxes -d capgirl | lolcat
	break
	;;
	"Ganti Password VPS")
	clear
	...
	echo "Ciieeee.. Ciieeeeeee.. Abis Ganti Password VPS Nie Yeeee...!!!"| boxes -d capgirl | lolcat
	break
	;;
	...
	echo "Sesudah..." | lolcat
	free -h
	echo "SUKSES..!!!Cache ram anda sudah di bersihkan." | boxes -d capgirl | lolcat
        break
	;;
	"Daftar User Aktif")
	clear
	user-active-list | boxes -d capgirl | lolcat
	break
	;;
	...
	"Benchmark")
	clear
	echo "BENCHMARK" | boxes -d capgirl | lolcat
	benchmark | lolcat
	break
	;;
        "Edit Banner Login")
	...
	clear
	 ...
	 echo "Webmin sudah di restart boss!!!" | boxes -d capgirl| lolcat
	 break
	 ;;
	 "Restart Server VPS")
	 clear
	 reboot
	 echo "sudah di restart tunggu sebentar ya boss!!!" | boxes -d capgirl | lolcat
	 break
	 ;;
	 "Restart Dropbear")
	 clear
	 service dropbear restart
	 echo "Dropbear sudah di restart boss!!!" | boxes -d capgirl | lolcat
	 break
	 ;;
	 "Restart OpenSSH")
	 clear
	 service ssh restart
	 echo "OpenSSH sudah di restart boss!!!" | boxes -d capgirl | lolcat
	 break
	 ;;
	 "Restart OpenVPN")
	 clear
	 service openvpn restart
	 echo "openvpn sudah di restart boss!!!" | boxes -d capgirl | lolcat
	 break
	 ;;
	 "Restart Squid3")
	 clear
	 service squid3 restart
	 echo "Squid3 sudah di restart boss!!!" | boxes -d capgirl | lolcat
	 break
	 ;;
	 "Ganti Port OpenSSH")
	 clear
            echo "Silahkan ganti port Openssh anda lalu klik enter."| boxes -d capgirl | lolcat
...
Port dropbear tidak boleh sama dengan port openVPN/openSSH/squid3 !!!"| boxes -d peek | lolcat
	 ...
	 "Ganti Port Squid3")
	 clear
	 echo "Silahkan ganti port Squid3 anda lalu klik enter"| boxes -d capgirl | lolcat
	 ...
	 "Ganti Port OpenVPN")
	 clear
	           echo "Silahkan ganti port OpenVPN anda lalu klik enter?"| boxes -d capgirl | lolcat
